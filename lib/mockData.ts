...
export const mockJobs: Job[] = [
  ...
  {
    id: 'job-14',
    title: 'Clinical Service Manager — Community Mental Health',
    organisation: 'Hertfordshire NHS Foundation Trust',
    location: 'St Albans',
    region: 'Hertfordshire',
    ...
    sector: 'NHS',
    description:
      'Lead a community mental health team delivering services across south Hertfordshire, with operational and clinical-governance responsibility.',
    postedAt: daysAgo(30),
  },
  {
    id: 'job-15',
